...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_quill_assets_icons_align_left_svg__ = __webpack_require__(111);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_quill_assets_icons_align_center_svg__ = __webpack_require__(110);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_quill_assets_icons_align_right_svg__ = __webpack_require__(112);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_quill_assets_icons_collapse_two_arrows_diagonal_symbol_svg__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_quill_assets_icons_collapse_two_arrows_diagonal_symbol_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_quill_assets_icons_collapse_two_arrows_diagonal_symbol_svg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__BaseModule__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_quill__ = __webpack_require__(109);
...
var Parchment = __WEBPACK_IMPORTED_MODULE_5_quill___default.a.imports.parchment;
...
var Toolbar = function (_BaseModule) {
	...
	function Toolbar() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Toolbar.__proto__ || Object.getPrototypeOf(Toolbar)).call.apply(_ref, [this].concat(args))), _this), _this.onCreate = function () {
			...
			// Setup Minimize
			_this._addMinimizeButton();
		}, _this.onDestroy = function () {}, _this.onUpdate = function () {
			_this.overlays.forEach(function (obj) {
				_this._positionOverlay(obj);
			});
		...
		}, _this._addMinimizeButton = function () {
			var minimize = document.createElement("div");
			Object.assign(minimize.style, _this.options.toolbarButtonStyles);
			minimize.innerHTML = __WEBPACK_IMPORTED_MODULE_3_quill_assets_icons_collapse_two_arrows_diagonal_symbol_svg___default.a;
			_this.toolbar.appendChild(minimize);

			minimize.addEventListener("click", _this._handleMinimize);
		}, _this._handleMinimize = function (event) {
			(function (img) {
				// Need fullsize width when expanding <img> again
				var fullsizeWidth = img.width;

				var minimizeOverlay = document.createElement("div");
				Object.assign(minimizeOverlay.style, _this.options.minimizeOverlayStyles);
				minimizeOverlay.style.width = fullsizeWidth + "px";
				var overlayObj = {
					dom: minimizeOverlay,
					img: img
				};
				_this.overlays.push(overlayObj);

				_this._positionOverlay(overlayObj);
				...
				_this.quill.root.parentElement.appendChild(minimizeOverlay);
				...
				observer.observe(_this.quill.root, {
					attributes: true,
					childList: true,
					characterData: true
				});

				_this._hideImage(img);

				minimizeOverlay.addEventListener("click", function (e) {
					_this._removeOverlay(overlayObj, observer, fullsizeWidth);
				});

				_this.hide();
			})(_this.img);
		}, _this._positionOverlay = function (_ref2) {
			var dom = _ref2.dom,
			    img = _ref2.img;
			...
			var editorDOM = _this.quill.root.parentElement;
			var editorRect = editorDOM.getBoundingClientRect();
			var left = imgRect.left - editorRect.left - 1;
			var top = imgRect.top - editorRect.top;
			var scrollTop = editorDOM.scrollTop;

			// Style the overlay
			dom.style.left = "" + left + "px";
			dom.style.top = "" + (top + scrollTop) + "px";
		}, _this._hideImage = function (img) {
			// Hide and "resize" <img> to give the impression of being minimized
			var imgIndex = _this.quill.getIndex(__WEBPACK_IMPORTED_MODULE_5_quill___default.a.find(img));
			_this.quill.formatText(imgIndex, 1, {
				'height': '35px',
				'visibility': 'hidden'
			}, 'silent');
		}, _this._removeOverlay = function (_ref3, obs, width) {
			var dom = _ref3.dom,
			    img = _ref3.img;
			...
			img.click();
			_this.overlays = _this.overlays.reduce(function (acc, overlay) {
				if (overlay.dom !== dom) acc.push(overlay);
				return acc;
			}, []);
			dom.remove();
	...
	return Toolbar;
}(__WEBPACK_IMPORTED_MODULE_4__BaseModule__["a" /* BaseModule */]);
...
var apply = __webpack_require__(17),
    ...
    customDefaultsMerge = __webpack_require__(68),
    mergeWith = __webpack_require__(106);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__DefaultOptions__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_DisplaySize__ = __webpack_require__(35);
...
var assignMergeValue = __webpack_require__(18),
    ...
    cloneTypedArray = __webpack_require__(62),
    copyArray = __webpack_require__(63),
...
module.exports = "<svg viewBox=\"0 0 18 18\" style=\"fill: rgb(68, 68, 68); stroke: rgb(68, 68, 68); stroke-width: 2;\">\n\t<line class=\"ql-stroke\" x1=\"2\" x2=\"8\" y1=\"16\" y2=\"10\"></line>\n\t<line class=\"ql-stroke\" x1=\"3\" x2=\"8\" y1=\"10\" y2=\"10\"></line>\n\t<line class=\"ql-stroke\" x1=\"8\" x2=\"8\" y1=\"10\" y2=\"15\"></line>\n\n\t<line class=\"ql-stroke\" x1=\"16\" x2=\"10\" y1=\"2\" y2=\"8\"></line>\n\t<line class=\"ql-stroke\" x1=\"10\" x2=\"10\" y1=\"8\" y2=\"3\"></line>\n\t<line class=\"ql-stroke\" x1=\"10\" x2=\"15\" y1=\"8\" y2=\"8\"></line>\n</svg>\n"
